...
item_set = {16084,{14546,14961,15625,15711,MOD_DOUBLE_ATTACK,5}, 	-- 	Ares's set (5% DA)
			...
			10877,{10451,10501,11970,10601,MOD_CRITHITRATE,6};    	-- Athos's Armor set  crit rate +6%. (crit rate 3% for the first 2 pieces, +1% for each additional piece)
			10878,{10452,10502,11971,10602,MOD_FASTCAST,10};     	-- Rubeus' Armor set  "Fast Cast" effect +10% (2 or 3 pieces equipped: Fast Cast +4, 4 or 5 pieces equipped: Fast Cast +10)
			10876,{10450,10500,11969,10600,MOD_REFRESH,2};		  	-- Ogier's Armor set 1  -3 pieces 1% Refresh, 4-5 pieces 2% Refresh
			27652,{27792,27932,28075,28212,MOD_MATT,9};          	-- Morrigan's Armor +1 set   Magic Attack Bonus +9 with all 5 pieces
			27651,{27791,27931,28074,28211,MOD_FASTCAST,9};       	-- Marduk's Armor +1    Fast Cast +9% with full set
			27649,{27789,27929,28072,28209,MOD_CRITHITRATE,9};    	-- Skadi's Armor +1    Crit hit rate +9% with full set
			27648,{27788,27928,28071,28208,MOD_DOUBLE_ATTACK,9};    -- Ares' Armor +1    Double Attack effect +9% with full set
			27650,{27790,27930,28073,28210,MOB_HASTE_GEAR,90}};     -- Usukane Armor +1    Haste (Gear) +9% with full set

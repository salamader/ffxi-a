...
EFFECT_IMMINENT_STRIKES			= 490
EFFECT_AVATAR             			= 491 -- EFFECT_MNK_SP2 CONSUMATE_COUNTER
EFFECT_ASYLUM					= 492
EFFECT_SUBTLE_SORCERY			= 493
EFFECT_ENCOMIUM					= 494
EFFECT_BAMBOOZLE				= 495
EFFECT_RIGHTEOUS_GAURD			= 496
EFFECT_SOUL_ENSLAVEMENT			= 497
EFFECT_BST_SP2					= 498
EFFECT_MALINCONICO				= 499
EFFECT_INSTINCTIVE_AIM			= 500
EFFECT_YAEGASUMI				= 501
EFFECT_TENGEN					= 502
EFFECT_ROUSE_WYVERN				= 503
EFFECT_ASTRAL_CONDUIT			= 504
EFFECT_UNBRIDLED_WISDOM			= 505
EFFECT_THREE_TO_ONE				= 506
EFFECT_GRAND_PAS				= 507
-- EFFECT_NONE					= 508
-- EFFECT_NONE					= 509
EFFECT_NINJUTSU_ELE_DEBUFF			= 510 -- EFFECT_ERGON_MIGHT
EFFECT_REIVE_MARK				= 511
EFFECT_HEALING            			= 512 -- EFFECT_IONIS
EFFECT_LEAVEGAME          			= 513 -- EFFECT_BOLSTER
-- EFFECT_NONE          			= 514
...
MOD_RACC			= 0x1A
MOD_ENMITY			= 0x1B
MOD_TRANQUIL_HEART	= 0x233
MOD_MATT			= 0x1C
MOD_MDEF			= 0x1D
MOD_MACC			= 0x1E
MOD_MEVA			= 0x1F
MOD_MAG_DMG_STAT	= 0x243
MOD_MAG_BURST_BONUS	= 0x19E
MOD_ELEM_MAG_DMG	= 0x1A2
MOD_ENFB_MAG_DMG	= 0x1A3
MOD_NIN_MAG_DMG		= 0x1A4
...
MOD_CRIT_DMG		= 0x1CB
MOD_MAGIC_CRIT_RATE	= 0x22F
MOD_MAG_CRIT_DMG	= 0x230
MOD_SHIELD_DEF		= 0x1CC
...
MOD_SHIELD_MASTERY		= 0x1CD
MOD_DIVINE_EMBLEM		= 0x21C
MOD_BLOCK_RATE			= 0x21D

-- Dark Knight
MOD_OCCULT_ACCUMEN		= 0x1D0
MOD_STALWART_SOUL		= 0x1D5
MOD_WEAPON_BASH			= 0x1B1
MOD_DARK_MAG_CAST		= 0x1DA
MOD_ABSORB_POTENCY		= 0x21E
MOD_ABSORB_DURATION		= 0x21F
MOD_SCARLET_DMG			= 0x229
MOD_SCARLET_MDMG		= 0x22A

-- Warrior
MOD_DOUBLE_ATTACK		= 0x120
MOD_RETALIATION_DMG		= 0x1DB
MOD_BLOOD_RAGE			= 0x228
...
MOD_KICK_DMG        	= 0x182
MOD_TACTICAL_GUARD		= 0x1CE
MOD_MARTIAL_ARTS		= 0xAD
MOD_COUNTER_BASE_DMG	= 0x1D9
MOD_PFT_COUNTER_DMG		= 0x21A

-- White Mage
MOD_AFFLATUS_SOLACE		= 0x125
MOD_AFFLATUS_MISERY		= 0x126
MOD_CURE_CAST			= 0x18E
MOD_HEALING_CAST		= 0x194
MOD_DIVINE_BENISON_FASTCAST		= 0x234
MOD_DIVINE_BENISON_ENMITY		= 0x235

-- Black Mage
MOD_CLEAR_MIND			= 0x127
MOD_CONSERVE_MP			= 0x128
MOD_ELEMENTAL_CAST		= 0x193
MOD_ELEMENTAL_RECAST	= 0x188
MOD_BLACK_CAST			= 0x18D
MOD_MANA_WALL_DMG		= 0x21B

-- Thief
MOD_STEAL				= 0x12A
MOD_TRIPLE_ATTACK		= 0x12E
MOD_TREASURE_HUNTER     = 0x12F
MOD_SNEAK_ATK_MOD		= 0x1CA
MOD_TRICK_ATK_MOD		= 0x1D6
MOD_SATA_DMG			= 0x1D7
MOD_GILFINDER			= 0x1D4
MOD_DESPOIL				= 0x1DC
...
MOD_STONESKIN			= 0x12C
MOD_PHALANX				= 0x12D
MOD_STONESKIN_CAST		= 0x191
MOD_ENHANCING_CAST		= 0x197			
MOD_ENFEEBLING_CAST		= 0x198
MOD_SABOTEUR			= 0x220

-- Beastmaster
MOD_TAME				= 0x130
MOD_CHARM_TIME			= 0x168
MOD_CHARM_CHANCE		= 0x19B
MOD_REWARD_HP_BONUS		= 0x16C
MOD_REWARD_RECAST		= 0x18C	

-- Bard
MOD_SONG_RECAST			= 0x187
MOD_SONG_CAST			= 0x18F
MOD_SONG_DURATION		= 0x1B3
MOD_SONG_EFFECTS		= 0x1C8
MOD_ALL_SONGS			= 0x1B4
MOD_ETUDE				= 0x1B5
MOD_REQUIEM				= 0x1B6
MOD_VIRELAI				= 0x1B7
...
MOD_NINJUTSU_RECAST		= 0x18A
MOD_UTSUSEMI_CAST		= 0x195
MOD_PARRY_RATE			= 0x22D

-- Blue Mage
MOD_BLUE_POINTS			= 0x135
MOD_BLUE_CAST			= 0x196	
MOD_BLUE_RECAST			= 0x189
MOD_BLUE_LEARN			= 0x231

-- Pets / Avatars / Wyverns / Automatons
MOD_PET_MABB			= 0x138
MOD_PET_MACC			= 0x139
MOD_PET_MDEF			= 0x1E8
...
-- Puppetmaster
MOD_AUTO_MELEE_SKILL	= 0x245
MOD_AUTO_RANGED_SKILL	= 0x246
MOD_AUTO_MAGIC_SKILL	= 0x247

-- Dancer
MOD_FINISHING_MOVES		= 0x14D
MOD_JIG_TIME			= 0x1A6
MOD_TACTICAL_PARRY		= 0x1CF
MOD_WALTZ_POTENCY		= 0x1DD
MOD_WALTZ_RCVD			= 0x1DE
MOD_STEP_ACCURACY       = 0x23D

-- Scholar
MOD_SUBLIMATION_EFFECT	= 0x14E
...
MOD_BLACK_MAGIC_COST    = 0x221         
MOD_WHITE_MAGIC_COST    = 0x222         
MOD_BLACK_MAGIC_CAST    = 0x223           
MOD_WHITE_MAGIC_CAST    = 0x224
MOD_BLACK_MAGIC_RECAST  = 0x225         
MOD_WHITE_MAGIC_RECAST  = 0x226            
MOD_ALACRITY_CELERITY_EFFECT = 0x227
MOD_GRIMOIRE_RECAST		= 0x19A
MOD_GRIMOIRE_CAST		= 0x190
...
MOD_SPIRIT_JUMP_TP		= 0x214
MOD_SPIRIT_JUMP_ATT		= 0x215
MOD_CONSERVE_TP			= 0x236

MOD_CRYSTAL_DROP		= 0x1D8
...
MOD_QUICK_MAGIC			= 0x199			
	
MOD_CHOCOBO_TIME		= 0x19F
MOD_WYVERN_BREATH       = 0x192
MOD_EAT_RAW_FISH		= 0x1A0
MOD_EAT_RAW_MEAT		= 0x1A1
MOD_AUTO_RERAISE		= 0x245

MOD_QUADRUPLE_ATTACK	= 0x1A5

MOD_SNEAK_DUR			= 0x1A7
MOD_INVIS_DUR			= 0x1A8
MOD_ENHANCING_DUR		= 0x1A9
MOD_BARSPELL_DUR		= 0x1AB
MOD_BARSPELL_PWR		= 0x1AC
MOD_DRAIN_ASPIR			= 0x1AD
MOD_CURSNA_EFFECT		= 0x1AE
MOD_CURSNA_RCVD			= 0x1AF

MOD_STONESKIN_HP		= 0x1AA

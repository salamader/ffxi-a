...
UNLOCK_MERITS = 1; -- Set to 1 to allow characters to change to gain limit points right away. 
...
UNLOCK_EXTRA_SPELLS = 0; -- Set to 1 to give starting characters all the unattainable Spells.
UNLOCK_TELEPORTATION_ITEMS = 0; -- Set to 1 to give starting characters all travel related items (Airship passes, chocobo license, teleport crystals, etc).
UNLOCK_CLAIM_SLIPS = 1; -- Set to 1 to give starting characters all the Claim Slips.
UNLOCK_ALL_EVENT_ITEMS_STORED = 1; -- Set to 1 to give starting characters all the Items stored on the Event Item Storage NPC.

SHOP_PRICE = 0.300; --Multiplies prices in NPC shops.
GIL_RATE   = 10.00; --Multiplies gil earned from quests.  Won't always display in game.
EXP_RATE   = 1.000; --Multiplies exp earned from fov.
TABS_RATE  = 6.000; --Multiplies tabs earned from fov.
...
SPELL_POWER = 1.464; --Multiplies damage dealt by Elemental and Divine Magic.
BLUE_POWER  = 1.456; --Multiplies damage dealt by most Blue Magic.
DRAIN_POWER = 2.500; --Multiplies amount drained by Drain, Aspir, and relevant Blue Magic spells.
ITEM_POWER  = 1.750; --Multiplies the effect of items such as Potions and Ethers.
PETFOOD_POWER  = 1.200; --Multiplies the effect of pet foods biscuits and pet healing items.
...
HARVESTING_BREAK_CHANCE = 0.09; --% chance for the sickle to break during harvesting.  Set between 0 and 1.
EXCAVATION_BREAK_CHANCE = 0.09; --% chance for the pickaxe to break during excavation.  Set between 0 and 1.
LOGGING_BREAK_CHANCE    = 0.09; --% chance for the hatchet to break during logging.  Set between 0 and 1.
MINING_BREAK_CHANCE     = 0.09; --% chance for the pickaxe to break during mining.  Set between 0 and 1.
HARVESTING_RATE         = 0.80; --% chance to recieve an item from haresting.  Set between 0 and 1.
EXCAVATION_RATE         = 0.80; --% chance to recieve an item from excavation.  Set between 0 and 1.
LOGGING_RATE            = 0.80; --% chance to recieve an item from logging.  Set between 0 and 1.
MINING_RATE             = 0.80; --% chance to recieve an item from mining.  Set between 0 and 1.
...
COFFER_MAX_ILLUSION_TIME = 840;  -- 14 minutes
COFFER_MIN_ILLUSION_TIME = 360;  -- 6 minutes
CHEST_MAX_ILLUSION_TIME  = 840;  -- 14 minutes
CHEST_MIN_ILLUSION_TIME  = 360;  -- 6 minutes
...
-- DYNAMIS SETTINGS
    ...
    TIMELESS_HOURGLASS_COST = 200000;   -- cost of the timeless hourglass for Dynamis.
...
RELIC_2ND_UPGRADE_WAIT_TIME = 73800;      -- wait time for 2nd relic upgrade (stage 2 -> stage 3) in seconds. 604800s = 1 RL week.
RELIC_3RD_UPGRADE_WAIT_TIME = 73800;    -- wait time for 3rd relic upgrade (stage 3 -> stage 4) in seconds. 295200s = 82 hours.
...
WSNM_LEVEL = 60; -- Min Level to get WSNM Quests
...
AF3_QUEST_LEVEL = 45; -- Minimum level to start AF3 quest
...
QM_RESET_TIME = 150; -- Default time (in seconds) you have from killing ???-pop mission NMs to click again and get key item, until ??? resets.
...
SCAVENGE_RATE = 0.8; --The chance of obtaining an item when you use the Ranger job ability Scavenge.  Do not set above 1!
STATUS_RESIST_MULTIPLIER = 20; -- Sets the strength of status resist traits.
...
KILLER_EFFECT = 25; -- Intimidation percentage from killer job traits.
...
BARD_SONG_LIMIT = 3; --Maximum amount of songs from a single Bard that can be granted to a single target at once.  Set between 1 and 31.
BARD_INSTRUMENT_LIMIT = 5; --Maximum amount of songs from a single Bard with an instrument that can be granted to a single target at once.  Set between 2 and 32.
ENHANCING_SONG_DURATION = 300; -- duration of enhancing bard songs such as Minuets, Ballads, etc.
STONESKIN_CAP = 600; -- soft cap for hp absorbed by stoneskin
BLINK_SHADOWS = 4;   -- number of shadows supplied by Blink spell
ENSPELL_DURATION = 360; -- duration of RDM en-spells
SPIKE_EFFECT_DURATION = 360; -- the duration of RDM, BLM spikes effects (not Reprisal)
ELEMENTAL_DEBUFF_DURATION = 300; -- base duration of elemental debuffs
STORM_DURATION = 240; -- duration of Scholar storm spells
KLIMAFORM_MACC = 40;  -- magic accuracy added by Klimaform. 30 is just a guess.
AQUAVEIL_INTERR_RATE = 33;  -- percent spell interruption rate reduction from Aquaveil (see http://www.bluegartrls.com/forum/82143-spell-interruption-down-cap-aquaveil-tests.html)
ABSORB_SPELL_AMOUNT = 24; -- how much of a stat gets absorbed by DRK absorb spells - expected to be a multiple of 8.
ABSORB_SPELL_TICK = 9; -- duration of 1 absorb spell tick
SNEAK_INVIS_DURATION_MULTIPLIER = 3; -- multiplies duration of sneak,invis,deodorize to reduce player torture. 1 = retail behavior. MUST BE INTEGER.

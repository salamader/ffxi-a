...
function onEffectGain(target,effect)
	...
	elseif(effect:getPower() == 14) then
		target:addMod(MOD_ATT, effect:getSubPower());
	...
	elseif(effect:getPower() == 17) then
		target:addMod(MOD_RATT, effect:getSubPower());
...
function onEffectLose(target,effect)
	...
	elseif(effect:getPower() == 14) then
		target:delMod(MOD_ATT, effect:getSubPower());
	elseif(effect:getPower() == 15) then
		target:delMod(MOD_ACC, effect:getSubPower());
	elseif(effect:getPower() == 16) then
		target:delMod(MOD_MATT, effect:getSubPower());
	elseif(effect:getPower() == 17) then
		target:delMod(MOD_RATT, effect:getSubPower());
	elseif(effect:getPower() == 18) then

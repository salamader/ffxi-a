...
-- @zone 236
-- @pos 40.000, 8.000, -210.000
--
-- Menu
-- startEvent(0x0197, Item1, (Item2 or Dial #), Item3, 0, MysteryBoxTally)
--
...
function onTrade(player,npc,trade)
	...
	if(player:getVar("MysteryBoxTally") == 10000) then
		player:startEvent(0x019C); -- tally points total full
	elseif(player:getVar("MysteryTradeTally") == 10) then
		player:startEvent(0x019B); -- tally points for trades full for day
	elseif(count == 1) then
		player:startEvent(0x0199, 0, 0, 0, 0, 0, tallyIncrease); -- take item add tally points
	else
		player:startEvent(0x019A); -- don't take item
	end
end; 
...
function onTrigger(player,npc)
	...
	if(player:getVar("GoblinMysteryBox") == 0) then -- Initial CS tracking
		player:startEvent(0x0196); -- first diagloge explanation
	else
		...
		player:startEvent(0x0197,peek1,peek2,peek3,var4,var5,var6,var7,var8); -- menu
	end
end; 
...
-- printf("RESULT: %u",option);
	if(csid == 0x0196) then -- shown explanation give initial tally points
...
-- player:startEvent(0x019D); -- transform to blue treasure chest

...
-- General Texts
ITEM_CANNOT_BE_OBTAINED = 6580; -- You cannot obtain the item <item> come back again after sorting your inventory
...
CHEST_UNLOCKED = 7234; -- You unlock the chest!
    CHEST_FAIL = 7235; -- Fails to open the chest. 
    CHEST_TRAP = 7236; -- The chest was trapped! 
    CHEST_WEAK = 7237; -- You cannot open the chest when you are in a weakened state.
   CHEST_MIMIC = 7238; -- The chest was a mimic! 
  CHEST_MOOGLE = 7239; -- You cannot open the chest while participating in the moogle event.
CHEST_ILLUSION = 7240; -- The chest was but an illusion...
  CHEST_LOCKED = 7241; -- The chest appears to be locked.

-- Mission Texts
      ORB_ALREADY_PLACED = 1; -- A dark Mana Orb is already placed here.

...
function onTrigger(player,npc)
	...
	elseif(player:getCurrentMission(BASTOK) == THE_SALT_OF_THE_EARTH and player:getVar("BASTOK91") == 2)then
		player:startEvent(0x0067);
	elseif(player:getCurrentMission(BASTOK) == THE_SALT_OF_THE_EARTH and player:getVar("BASTOK91") == 10 and player:hasKeyItem(MIRACLESALT))then

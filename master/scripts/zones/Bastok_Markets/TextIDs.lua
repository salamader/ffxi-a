...
-- Shop Texts
    SOMNPAEMN_CLOSED_DIALOG =  7365; --I'm trying to start a business selling goods from Sarutabaruta,
     ...
     OGGODETT_CLOSED_DIALOG =  7367; --I'm trying to start a business selling goods from Aragoneu,
         ...
         TEERTH_SHOP_DIALOG =  7468; --Welcome to the Goldsmiths' Guild shop.\nWhat can I do for you?
         VISALA_SHOP_DIALOG =  7469; --Welcome to the Goldsmiths' Guild shop.\nHow may I help you?
        ZHIKKOM_SHOP_DIALOG =  7470; --Welcome to the only weaponry store in Bastok,\nthe Dragon's Claws!
         CIQALA_SHOP_DIALOG =  7471; --A weapon is the most precious thing to an adventurer! Well, after his life, of course.
      PERITRAGE_SHOP_DIALOG =  7472; --Hey!\nI've got just the thing for you!
      BRUNHILDE_SHOP_DIALOG =  7473; --Welcome to my store!\nYou want armor, you want shields?\nI've got them all!
CHARGINGCHOKOBO_SHOP_DIALOG =  7474; --Hello.\nWhat piece of armor are you missing?
      BALTHILDA_SHOP_DIALOG =  7475; --Feeling defenseless of late?\nBrunhilde's Armory has got you covered!
          MJOLL_SHOP_DIALOG =  7476; --Welcome.\nHave a look and compare! You'll never find better wares anywhere.
          OLWYN_SHOP_DIALOG =  7477; --Welcome to Mjoll's Goods!\nWhat can I do for you?
          ZAIRA_SHOP_DIALOG =  7478; --Greetings.\nWhat spell are you looking for?
      ...
      CARMELIDE_SHOP_DIALOG =  7481; --Ah, welcome, welcome!\nWhat might I interest you in?
          RAGHD_SHOP_DIALOG =  7482; --Give a smile to that special someone! Welcome to Carmelide's.
       HORTENSE_SHOP_DIALOG =  7483; --Hello there!\nWe have instruments and music sheets at Harmodios's!
       OGGODETT_OPEN_DIALOG =  7484; --Hello there!\nMight I interest you in some specialty goods from Aragoneu?
         YAFAFA_OPEN_DIALOG =  7485; --Hello!\nI've got some goods from Kolshushu--interested?
      SOMNPAEMN_OPEN_DIALOG =  7486; --Welcome!\nI have goods straight from Sarutabaruta! What say you?